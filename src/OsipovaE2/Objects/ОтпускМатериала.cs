...
namespace IIS.OsipovaE2
{
    ...
    public class ОтпускМатериала : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OsipovaE2.Заказ fЗаказ;
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        [NotNull()]
        public virtual IIS.OsipovaE2.Заказ Заказ
        {
            get
            {
                ...
                IIS.OsipovaE2.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОтпускМатериалаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтпускМатериалаE", typeof(IIS.OsipovaE2.ОтпускМатериала));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОтпускМатериалаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОтпускМатериалаL", typeof(IIS.OsipovaE2.ОтпускМатериала));
                }
            }
        }
    }
